...
def main():
    try:
        ...
        # HHhdlist.save_json_config({"Platform_type": "Potevio"})
        # while True:
        ...
        #         HHhdlist.save_json_config({"deviceCode": HStategrid.Device_ID})
        #         HHhdlist.save_json_config({"deviceName": HStategrid.Device_ID})
        #         break
        HDevice.hhd_init()
        ...
        HSyslog.log_error(f"main error: {e}")
